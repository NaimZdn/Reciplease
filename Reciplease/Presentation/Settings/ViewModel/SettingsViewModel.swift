...
//  Reciplease
//
//  Created by Zidouni on 12/06/2023.
//
...
class SettingsViewModel: ObservableObject {
    ...
    Notification(identifier: "lunchtime", title: "Time to find new recipes !", body: "It's almost time to eat, come and find new ideas for dishes", hour: 11, minutes: 00, isDaily: true),
    Notification(identifier: "evening", title: "Time to find new recipes !", body: "What could be better than a new dish after a long day? ", hour: 18, minutes: 00, isDaily: true)
    ]
